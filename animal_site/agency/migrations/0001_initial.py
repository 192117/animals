    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animal', models.ForeignKey(blank=True, help_text='Выберите животное из списка. В случае отсутствия необходимого животного, оставьте поле пустое.', null=True, on_delete=django.db.models.deletion.CASCADE, to='animal.animals', verbose_name='Выбранное животное')),
            ],
            options={
